...
function TampilkanMenuModul() {
  echo "<p align=center><a href=\"?mnux=".__path_mnux__."&token=ExprdPngmmn\">Pengumuman yang Expired</a> |
    <a href=\"?mnux=".__path_mnux__."&token=\">Daftar Pengumuman</a> |
    <a href=\"?mnux=".__path_mnux__."&token=DftrGrp\">Daftar Group</a> |
...
function PngmmnEdt() {
  $md = $_REQUEST['md']+0;
  $script_judul = "<input type=text name='Judul' size=100 maxlength=100";
  $disabled = "";
  $script_tombol = "<input type=submit name='Simpan' value='Simpan'>
  <input type=reset name='Reset' value='Reset'>
  <input type=button name='Batal' value='Batal' onClick=\"location='?mnux=".__path_mnux__."&token=DftrPngmmn'\">";
  if ($md == 0) {
    ...
    $jdl = "Edit Pengumuman";
    $script_tombol = "<input type=button name='Kembali' value='Batal' onClick=\"location='?mnux=".__path_mnux__."&token=ExprdPngmmn'\">";
  }
  else {
    $w = array();
    $w[Judul] = '';
  ...
  <tr><td class=inp1>Judul</td><td class=ul>$_grid</td></tr>
  <tr><td class=inp1>Tanggal</td><td class=ul><input type=text name='TanggalMulai' value='$w[TanggalMulai]' id=\"from\" readonly=\"readonly\" ".$disabled."> s.d. <input type=text name='TanggalSelesai' value='$w[TanggalSelesai]' id=\"to\" readonly=\"readonly\" ".$disabled."></td></tr>
  <tr><td class=inp1>Urutan</td><td class=ul><input type=text name='Urutan' value='$w[Urutan]' size=5 maxlength=5".$disabled."></td></tr>
  <tr><td class=inp1>Konten</td><td class=ul><textarea name='Konten' id='Konten'".$disabled.">$w[Konten]</textarea></td></tr>
  <tr><td colspan=2>".$script_tombol."</td></tr>
  </form></table></p>
  <script>
  $js_script
  </script>";
...
// *** Main ***
TampilkanJudul("Master Pengumuman");
$token();
?>
